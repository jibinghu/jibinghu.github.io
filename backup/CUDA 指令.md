...
参考：https://zhuanlan.zhihu.com/p/677616101
...
``` cuda
block_id = (ctaid.x % X_dim) * (gridDim.y) + (ctaid.x / X_dim);
```
...
https://link.zhihu.com/?target=https%3A//developer.nvidia.com/blog/cooperative-groups/
https://link.zhihu.com/?target=https%3A//developer.nvidia.com/blog/cuda-pro-tip-increase-performance-with-vectorized-memory-access/
